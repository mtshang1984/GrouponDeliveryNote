...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(718, 456)
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(30, 350, 80, 30))
        self.label_3.setObjectName("label_3")
        self.lineEditDeliveryNote = QtWidgets.QLineEdit(Dialog)
        self.lineEditDeliveryNote.setEnabled(True)
        self.lineEditDeliveryNote.setGeometry(QtCore.QRect(130, 350, 461, 30))
        ...
        self.pushButtonOpenDeliveryNote.setGeometry(QtCore.QRect(130, 410, 100, 30))
        ...
        self.pushButtonAbout.setGeometry(QtCore.QRect(490, 410, 100, 30))
        self.pushButtonAbout.setObjectName("pushButtonAbout")
        self.pushButtonCheckUpdate = QtWidgets.QPushButton(Dialog)
        self.pushButtonCheckUpdate.setGeometry(QtCore.QRect(370, 410, 100, 30))
        self.pushButtonCheckUpdate.setObjectName("pushButtonCheckUpdate")
        self.groupBox = QtWidgets.QGroupBox(Dialog)
        self.groupBox.setGeometry(QtCore.QRect(10, 10, 701, 311))
        ...
        self.listViewSequence.setGeometry(QtCore.QRect(90, 150, 231, 141))
        ...
        self.listViewTitleSequence.setGeometry(QtCore.QRect(460, 150, 231, 141))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 330, 701, 71))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "GrouponDeliveryNote V1.2.1"))
